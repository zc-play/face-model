...
parser.add_option("-p", "--path", dest="test_path", help="Path to test data.", default='')
...
for i, layer in enumerate(model_classifier.layers):
    print(i, layer.name, layer.input_shape, 'trainable:{}'.format(layer.trainable))
...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
    ...
    # cv2.imshow('img', img)
    # cv2.waitKey(0)
    cv2.imwrite('./result_imgs/{}.jpg'.format(idx), img)
