    ...
    def detect_face(self, img):
        ...
        for key in bboxes:
            ...
            try:
                ...
                continue
            # filter_indexs = np.where(new_probs > 0.95)
            # new_boxes, new_probs = new_boxes[filter_indexs], new_probs[filter_indexs]
